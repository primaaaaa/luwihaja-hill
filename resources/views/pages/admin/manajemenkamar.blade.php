...
<div class="p-4">
    <x-data-table title="Daftar Kamar" :headers="$tableHeader"
        ...
        <div class="modal fade" id="deleteModal{{ $room->id_tipe_villa }}" tabindex="-1">
                ...
                <div class="modal-content delete-modal">
                    ...
                    <div class="modal-body text-center delete-modal-body">
                        <h6 class="fw-bold mb-3 delete-title">
                            Apakah Anda yakin ingin<br>menghapus kamar {{ $room->nama_unit }}?
                        </h6>
                        <div class="d-flex gap-2 justify-content-center mt-4">
                            <button class="btn btn-tidak" data-bs-dismiss="modal">Tidak</button>
                            <form action="{{ route('admin.kamar.delete', $room->id_tipe_villa) }}" method="POST"
                                class="d-inline">
                                @csrf
                                @method('DELETE')
