...
<div class="p-4">
    <x-data-table title="Daftar Kamar" :headers="$tableHeader"
        ...
        <x-add-modal route="admin.kamar.store" title="Tambah Kamar">
            <div class="row g-3">
                <div class="col-md-6">
                    <x-input-field type="text" label="Kode Tipe" name="kode_tipe" :value="$nextKodeTipe"
            ...
            <div class="row g-3 mt-1">
                <div class="col-md-6">
                    <x-input-field type="number" label="Kapasitas" name="kapasitas" placeholder="Masukkan kapasitas"
                        min="1" required="true"></x-input-field>
            ...
            <div class="row g-3 mt-1">
                <div class="col-md-6">
                    <x-input-field type="number" label="Harga Weekday" name="harga_weekday"
                        placeholder="Masukkan harga weekday" min="0" required="true"></x-input-field>
                </div>
                <div class="col-md-6">
                    <x-input-field type="number" label="Harga Weekend" name="harga_weekend"
                        placeholder="Masukkan harga weekend" min="0" required="true"></x-input-field>
                </div>
            </div>
