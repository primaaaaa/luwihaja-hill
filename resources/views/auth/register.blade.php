      ...
      <div class="form-container">
        ...
        <form id="registerForm">
          ...
          <div class="input-group">
            <div class="input-wrapper" id="namaWrapper">
          ...
          <div class="input-group">
            <div class="input-wrapper" id="noTeleponWrapper">
              <input type="tel" id="noTelepon" name="noTelepon" placeholder="No. Telepon" required>
              <span class="input-icon" aria-hidden="true">
            ...
            <div class="error-message" id="noTeleponError">No. telepon wajib diisi.</div>
          </div>
          ...
          <div class="input-group">
            <div class="input-wrapper" id="password_confirmationWrapper">
            ...
            <div class="error-message" id="password_confirmationError">Konfirmasi password wajib diisi.</div>
          </div>
